...
public class Kathy : MonoBehaviour
{
    ...
    void MotherTree()
    {
        ...
        if (scene == 2 && count == 0)
        {
            ...
            playerText = "Alright, Cathy, where’s Charlie!?";
            useButtons = false;
        }
        ...
        if (scene == 2 && count == 1)
        {
            ...
            npcText = "I’m sorry! She’s in the closet. I got grounded and I got scared if I told anyone I took Charlie, I’d get in even more trouble.";
        }
